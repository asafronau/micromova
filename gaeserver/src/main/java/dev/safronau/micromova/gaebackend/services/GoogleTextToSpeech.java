...
public class GoogleTextToSpeech implements TextToSpeech {
  ...
  private static final ImmutableTable<Language, VoiceGender, String> TTS_VOICE_NAME =
      ImmutableTable.<Language, VoiceGender, String>builder()
          ...
          .put(Language.EN_US, VoiceGender.FEMALE, "en-US-Studio-O")
          .put(Language.EN_US, VoiceGender.MALE, "en-US-Studio-Q")
          .put(Language.FR, VoiceGender.FEMALE, "fr-FR-Studio-A")
          .put(Language.FR, VoiceGender.MALE, "fr-FR-Studio-D")
